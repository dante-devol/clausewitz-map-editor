...
> **Status (2026-09-11): all of section 4 addressed, including both halves of 4.3.**
...
> - Tests: `npm test` (`provinceEditSelectors.test.ts`, `useMapCanvas.mergeBboxGroups.test.ts`, `canvasSizing.test.ts`, `provinceAnalysis.test.ts`, `decodeBmp24.test.ts`, `BmpProvinceMapSource.test.ts`).
